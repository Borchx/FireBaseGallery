...
import com.borja.android.firestorage.databinding.ActivityUploadComposeBinding
import com.borja.android.firestorage.ui.compose.list.ListComposeActivity
    ...
    fun UploadScreen() {
        ...
        val intentGalleryLauncher =
            rememberLauncherForActivityResult(ActivityResultContracts.GetContent()) {
                if (it?.path?.isNotEmpty() == true) { // comprobar la URI
                    uploadComposeViewModel.uploadAndGetImage(it) { newUri -> resultUri = newUri }
                }
            }
                ...
                Card(shape = RoundedCornerShape(12), elevation = 12.dp) {
                    Column(modifier = Modifier.padding(24.dp)) {
                        ...
                        OutlinedButton(
                            ...
                            Text("Gallery", color = colorResource(id = R.color.green))
                        }
                    }
                }
            }
        ...
        Column(Modifier.fillMaxSize()) {
                ...
                if (!loading && resultUri == null) {
                    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                        Icon(
                            ...
                            contentDescription = "icon upload",
            ...
            OutlinedButton(
                onClick = { startActivity(ListComposeActivity.create(context)) }, modifier = Modifier
                    .fillMaxWidth()
                    .padding(36.dp)
